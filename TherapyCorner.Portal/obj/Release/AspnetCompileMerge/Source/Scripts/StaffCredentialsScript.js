...
var puIgnoreCred;
var puWatchCred;
function InitializeCredentials(listSource, docSource, magnify,ignoreUrl,watchUrl,ignoreText,watchText, includeName,verifyUrl, msgUrl,verifyImg,msgImg )
{
...
function FinishFetch(returndata) {
    ...
    if (returndata.Credentials != null && returndata.Credentials.length > 0) {
        ...
        $.each(returndata.Credentials, function (index, itm) {
            var row = "<tr><td><div class='tdSingleButton'>"
